...
// Discord CDN assets supplied for BlancoCountyRP.
...
const SESSION_VOTE_THRESHOLD =
  Math.max(1, Number(process.env.SESSION_VOTE_THRESHOLD || 4));
...
// BCRP ROLE SYSTEM
// ============================================================
const BCRP_SETUP_ROLES = [
  '♛ | Founder','♚ | Co-Founder','♚ | Director','♚ | Deputy Director','BCRP | Leadership Team','Official Blanco County Roleplay Bots','─────────',
  'BCRP | Staff Coordinator','BCRP | Discord Management','BCRP | Staff Management','BCRP | Senior High Rank','─────────',
  "BCRP | Head Board Of Director's","BCRP | Executive Board Of Director's","BCRP | Board Of Director's",'─────────',
  "BCRP | Internal Affair's Team",'BCRP | Server Management','BCRP | High Rank','─────────',
  'BCRP | Head Administrator','BCRP | Administrator','BCRP | Trial Administrator','BCRP | Administration Team','─────────',
  'BCRP | Head Moderator','BCRP | Moderator','BCRP | Trial Moderator','BCRP | Moderation Team','─────────',
  'BOTS','BCRP | Employee','BCRP | Staff Team','BCRP | Partnership Manager','BCRP | Media Team Head','BCRP | Media Team','─────────',
  'BCRP | High Profile Member','BCRP | Gold Supporter Member','BCRP | Silver Supporter Member','✓ | Member','✗ | Unverified','─────────',
  'BCRP | Staff Strike 3','BCRP | Staff Strike 2','BCRP | Staff Strike 1','BCRP | HR Staff Termination','BCRP | Staff Termination','BCRP | Blacklisted','BCRP | Under Investigation','─────────',
  '𝒟 | Blanco County Fire & EMS','𝒟 | Blanco County Sheriff','𝒟 | Johnson Police','𝒟 | Texas DOT','Department Ambassador','𝒟 | Whitelisted Member','─────────',
  '𝓟 | Announcement Ping','𝓟 | Department Ping','𝓟 | Session Ping','𝓟 | Session Vote Ping','𝓟 | Session Boost Ping','𝓟 | Session Staff Vote Ping','𝓟 | Daily Bible Verse Ping','𝓟 | Dead Chat Revive Ping','𝓟 | Partnership Ping','─────────',
  'On Duty','On Break','Off Duty','Discord Staff','✓ | SSU Perms','✓ | SSD Perms','BCRP | Need-Retraining','BCRP | Need-Training','BCRP | Waiting-Ride-Along','BCRP | Waiting-Exam','BCRP | Staff Trainer'
];
const BCRP_SEPARATOR_ROLE = '─────────';
const BCRP_ROLE_PERMISSION_PROFILES = {
  '♛ | Founder':[PermissionFlagsBits.Administrator],'♚ | Co-Founder':[PermissionFlagsBits.Administrator],'♚ | Director':[PermissionFlagsBits.Administrator],
  '♚ | Deputy Director':[PermissionFlagsBits.ManageGuild,PermissionFlagsBits.ManageChannels,PermissionFlagsBits.ManageRoles,PermissionFlagsBits.ViewAuditLog,PermissionFlagsBits.ManageMessages,PermissionFlagsBits.ModerateMembers,PermissionFlagsBits.KickMembers,PermissionFlagsBits.BanMembers,PermissionFlagsBits.ManageNicknames],
  'BCRP | Leadership Team':[PermissionFlagsBits.ManageGuild,PermissionFlagsBits.ManageChannels,PermissionFlagsBits.ViewAuditLog,PermissionFlagsBits.ManageMessages,PermissionFlagsBits.ModerateMembers,PermissionFlagsBits.KickMembers,PermissionFlagsBits.ManageNicknames],
  'Official Blanco County Roleplay Bots':[PermissionFlagsBits.ViewChannel,PermissionFlagsBits.SendMessages,PermissionFlagsBits.EmbedLinks,PermissionFlagsBits.AttachFiles,PermissionFlagsBits.ReadMessageHistory,PermissionFlagsBits.ManageMessages],
  'BCRP | Staff Coordinator':[PermissionFlagsBits.ManageChannels,PermissionFlagsBits.ViewAuditLog,PermissionFlagsBits.ManageMessages,PermissionFlagsBits.ModerateMembers],
  'BCRP | Discord Management':[PermissionFlagsBits.ManageChannels,PermissionFlagsBits.ViewAuditLog,PermissionFlagsBits.ManageMessages,PermissionFlagsBits.ModerateMembers,PermissionFlagsBits.ManageNicknames],
  'BCRP | Staff Management':[PermissionFlagsBits.ManageChannels,PermissionFlagsBits.ViewAuditLog,PermissionFlagsBits.ManageMessages,PermissionFlagsBits.ModerateMembers,PermissionFlagsBits.KickMembers,PermissionFlagsBits.ManageNicknames],
  'BCRP | Senior High Rank':[PermissionFlagsBits.ViewAuditLog,PermissionFlagsBits.ManageMessages,PermissionFlagsBits.ModerateMembers,PermissionFlagsBits.KickMembers],
  "BCRP | Head Board Of Director's":[PermissionFlagsBits.ManageChannels,PermissionFlagsBits.ViewAuditLog,PermissionFlagsBits.ManageMessages,PermissionFlagsBits.ModerateMembers,PermissionFlagsBits.KickMembers],
  "BCRP | Executive Board Of Director's":[PermissionFlagsBits.ViewAuditLog,PermissionFlagsBits.ManageMessages,PermissionFlagsBits.ModerateMembers,PermissionFlagsBits.KickMembers],
  "BCRP | Board Of Director's":[PermissionFlagsBits.ViewAuditLog,PermissionFlagsBits.ManageMessages,PermissionFlagsBits.ModerateMembers],
  "BCRP | Internal Affair's Team":[PermissionFlagsBits.ViewAuditLog,PermissionFlagsBits.ManageMessages,PermissionFlagsBits.ModerateMembers],
  'BCRP | Server Management':[PermissionFlagsBits.ManageChannels,PermissionFlagsBits.ViewAuditLog,PermissionFlagsBits.ManageMessages,PermissionFlagsBits.ModerateMembers],
  'BCRP | High Rank':[PermissionFlagsBits.ViewAuditLog,PermissionFlagsBits.ManageMessages,PermissionFlagsBits.ModerateMembers,PermissionFlagsBits.KickMembers],
  'BCRP | Head Administrator':[PermissionFlagsBits.ViewAuditLog,PermissionFlagsBits.ManageMessages,PermissionFlagsBits.ModerateMembers,PermissionFlagsBits.KickMembers,PermissionFlagsBits.BanMembers],
  'BCRP | Administrator':[PermissionFlagsBits.ViewAuditLog,PermissionFlagsBits.ManageMessages,PermissionFlagsBits.ModerateMembers,PermissionFlagsBits.KickMembers],
  'BCRP | Trial Administrator':[PermissionFlagsBits.ManageMessages,PermissionFlagsBits.ModerateMembers],'BCRP | Administration Team':[PermissionFlagsBits.ManageMessages,PermissionFlagsBits.ModerateMembers],
  'BCRP | Head Moderator':[PermissionFlagsBits.ViewAuditLog,PermissionFlagsBits.ManageMessages,PermissionFlagsBits.ModerateMembers,PermissionFlagsBits.KickMembers],
  'BCRP | Moderator':[PermissionFlagsBits.ManageMessages,PermissionFlagsBits.ModerateMembers,PermissionFlagsBits.KickMembers],'BCRP | Trial Moderator':[PermissionFlagsBits.ManageMessages,PermissionFlagsBits.ModerateMembers],'BCRP | Moderation Team':[PermissionFlagsBits.ManageMessages,PermissionFlagsBits.ModerateMembers],
  'BOTS':[PermissionFlagsBits.ViewChannel,PermissionFlagsBits.SendMessages,PermissionFlagsBits.EmbedLinks,PermissionFlagsBits.AttachFiles,PermissionFlagsBits.ReadMessageHistory],
  'BCRP | Employee':[PermissionFlagsBits.ViewChannel,PermissionFlagsBits.ReadMessageHistory],'BCRP | Staff Team':[PermissionFlagsBits.ViewChannel,PermissionFlagsBits.ReadMessageHistory,PermissionFlagsBits.SendMessages],
  'BCRP | Partnership Manager':[PermissionFlagsBits.ViewChannel,PermissionFlagsBits.ReadMessageHistory,PermissionFlagsBits.SendMessages],'BCRP | Media Team Head':[PermissionFlagsBits.ViewChannel,PermissionFlagsBits.ReadMessageHistory,PermissionFlagsBits.SendMessages,PermissionFlagsBits.AttachFiles,PermissionFlagsBits.EmbedLinks],'BCRP | Media Team':[PermissionFlagsBits.ViewChannel,PermissionFlagsBits.ReadMessageHistory,PermissionFlagsBits.SendMessages,PermissionFlagsBits.AttachFiles],
  'Discord Staff':[PermissionFlagsBits.ViewChannel,PermissionFlagsBits.ReadMessageHistory,PermissionFlagsBits.SendMessages],'✓ | SSU Perms':[PermissionFlagsBits.ViewChannel,PermissionFlagsBits.ReadMessageHistory,PermissionFlagsBits.SendMessages],'✓ | SSD Perms':[PermissionFlagsBits.ViewChannel,PermissionFlagsBits.ReadMessageHistory,PermissionFlagsBits.SendMessages],'BCRP | Staff Trainer':[PermissionFlagsBits.ViewChannel,PermissionFlagsBits.ReadMessageHistory,PermissionFlagsBits.SendMessages]
};
const BCRP_STAFF_ROLE_NAMES = Object.keys(BCRP_ROLE_PERMISSION_PROFILES);
function getBcrpRole(guild,name){return guild.roles.cache.find(r=>r.name===name&&!r.managed)||null;}
async function ensureBcrpRoles(guild){
  const me=guild.members.me||await guild.members.fetchMe();
  if(!me.permissions.has(PermissionFlagsBits.ManageRoles)) throw new Error('The bot needs Manage Roles permission to create and configure BCRP roles.');
  const roleList=[],created=[],usedSeparators=new Set();
  for(const name of BCRP_SETUP_ROLES){
    let role=name===BCRP_SEPARATOR_ROLE?guild.roles.cache.find(r=>r.name===name&&!r.managed&&!usedSeparators.has(r.id)):getBcrpRole(guild,name);
    if(role&&name===BCRP_SEPARATOR_ROLE) usedSeparators.add(role.id);
    if(!role){role=await guild.roles.create({name,permissions:BCRP_ROLE_PERMISSION_PROFILES[name]||[],reason:'BlancoCountyRP /setup role creation'});created.push(role);}
    else if(BCRP_ROLE_PERMISSION_PROFILES[name]) await role.setPermissions(BCRP_ROLE_PERMISSION_PROFILES[name],'BlancoCountyRP /setup role permissions').catch(()=>{});
    roleList.push(role);
  }
  const editable=roleList.filter(r=>r&&r.editable);
  if(editable.length) await guild.roles.setPositions(editable.map((r,i)=>({role:r.id,position:editable.length-i}))).catch(e=>console.warn('BCRP role hierarchy warning:',e.message));
  return {roleList,created};
}
function getDepartmentRoleNames(){return ['𝒟 | Blanco County Fire & EMS','𝒟 | Blanco County Sheriff','𝒟 | Johnson Police','𝒟 | Texas DOT'];}
function getBcrpMemberRoleIds(guild){return ['✓ | Member','𝒟 | Whitelisted Member'].map(n=>getBcrpRole(guild,n)?.id).filter(Boolean);}
...
function getStaffAccessRoleIds(guild) {
  if (!guild) return [SERVER_STAFF_ROLE_ID, SERVER_MANAGEMENT_ROLE_ID, PARTNERSHIP_TEAM_ROLE_ID].filter(Boolean);
  return BCRP_STAFF_ROLE_NAMES.map(name => getBcrpRole(guild, name)?.id).filter(Boolean);
}
...
function setupPublicOverwrites(guild, readonly = false) {
  ...
  for (const roleId of getBcrpMemberRoleIds(guild)) {
    overwrites.push({ id: roleId, allow: [PermissionFlagsBits.ViewChannel, PermissionFlagsBits.ReadMessageHistory, ...(readonly ? [] : [PermissionFlagsBits.SendMessages])] });
  }
  for (const roleName of getDepartmentRoleNames()) {
    const role = getBcrpRole(guild, roleName);
    if (role) overwrites.push({ id: role.id, allow: [PermissionFlagsBits.ViewChannel, PermissionFlagsBits.ReadMessageHistory, ...(readonly ? [] : [PermissionFlagsBits.SendMessages])] });
  }
  for (const roleId of getStaffAccessRoleIds(guild)) {
    overwrites.push({ id: roleId, allow: [PermissionFlagsBits.ViewChannel, PermissionFlagsBits.ReadMessageHistory, PermissionFlagsBits.SendMessages, PermissionFlagsBits.EmbedLinks, PermissionFlagsBits.AttachFiles, PermissionFlagsBits.ManageMessages] });
  }
  if (client.user?.id) overwrites.push({ id: client.user.id, allow: [PermissionFlagsBits.ViewChannel, PermissionFlagsBits.ReadMessageHistory, PermissionFlagsBits.SendMessages, PermissionFlagsBits.EmbedLinks, PermissionFlagsBits.AttachFiles, PermissionFlagsBits.ManageMessages] });
  return overwrites;
}
...
async function rebuildBcrpServer(guild) {
...
const BCRP_LEGACY_CATEGORY_NAMES = new Set(['KCRP | Welcome Center','KCRP | Community','KCRP | Operations','KCRP | Staff Area','KCRP | Tickets','KCRP | Voice','King County Roleplay','KCRP','Old Setup','Legacy Setup']);
const BCRP_LEGACY_CHANNEL_NAMES = new Set(['welcome','dashboard','assistance','verify','announcements','sessions','polls','general','media','suggestions','departments','applications','application-results','application-review','staff-announcements','staff-chat','staff-logs','moderation-logs','staff-training','civilian-lounge','leo-lounge','fire-ems-lounge','staff-lounge','support','ticket-panel','ticketpanel','verification','rules','ingame-rules','discord-regulations','session-log','notice-board','development']);
async function cleanupLegacyBcrp(guild){
  const protectedCategories=new Set(Object.values(BCRP_SETUP_CATEGORIES));
  const protectedChannels=new Set(BCRP_SETUP_CHANNELS.map(d=>d.name));
  const deletedChannels=[],deletedCategories=[],deletedRoles=[];
  for(const ch of [...guild.channels.cache.values()]){
    if(!ch||protectedCategories.has(ch.name)||protectedChannels.has(ch.name)) continue;
    const parentName=ch.parent?.name||'';
    if(BCRP_LEGACY_CATEGORY_NAMES.has(parentName)||BCRP_LEGACY_CHANNEL_NAMES.has(ch.name)) await ch.delete('BlancoCountyRP /cleanup legacy resource').then(()=>deletedChannels.push(ch.name)).catch(()=>{});
  }
  for(const ch of [...guild.channels.cache.values()]){
    if(ch.type!==ChannelType.GuildCategory||protectedCategories.has(ch.name)) continue;
    if(BCRP_LEGACY_CATEGORY_NAMES.has(ch.name)) await ch.delete('BlancoCountyRP /cleanup legacy category').then(()=>deletedCategories.push(ch.name)).catch(()=>{});
  }
  const legacyRoles=new Set(['Texas DOT','Johnson City Police','Johnson Police','Blanco County Sheriff',"Blanco County Sheriff's Office",'Blanco County EMS','Blanco County Fire & EMS','Blanco County EMS & Fire Department']);
  for(const role of [...guild.roles.cache.values()]) if(!role.managed&&legacyRoles.has(role.name)) await role.delete('BlancoCountyRP /cleanup legacy department role').then(()=>deletedRoles.push(role.name)).catch(()=>{});
...
async function setupBcrpServer(guild, { rebuild = true, visibility = 'recommended' } = {}) {
  const roleResult = await ensureBcrpRoles(guild);
  ...
  const seed = [
    ...
    ['sessions', { flags: MessageFlags.IsComponentsV2, components: [buildSessionPanel(getSessionState(guild.id), guild)] }]
  ];
  ...
  return { categories, channels: created, ticketCategory, roleList: roleResult.roleList, createdRoles: roleResult.created };
}
...
const commands = [
  ...
  new SlashCommandBuilder()
    .setName('cleanup')
    .setDescription('Remove legacy BlancoCountyRP channels, categories, and old department roles.'),
  ...
  async interaction => {
    ...
    try {
      ...
      if (interaction.isChatInputCommand() && interaction.commandName === 'setup') {
        ...
        try {
          const result = await setupBcrpServer(interaction.guild, { rebuild: true, visibility });
          ...
          await interaction.editReply({
            content:
              ...
              `**Roles Created/Updated:** ${result.roleList?.length || 0}\n\n` +
          ...
          await interaction.editReply({ content: `Server setup stopped because Discord returned an error: **${error.message}**` });
        }
        return;
      }
      ...
      if (interaction.isChatInputCommand() && interaction.commandName === 'cleanup') {
        if (!interaction.guild) return interaction.reply({content:'Cleanup can only be used inside a server.',flags:MessageFlags.Ephemeral});
        if (!interaction.memberPermissions?.has(PermissionFlagsBits.Administrator)) return interaction.reply({content:'You need **Administrator** permission to use `/cleanup`.',flags:MessageFlags.Ephemeral});
        await interaction.deferReply({flags:MessageFlags.Ephemeral});
        try {
          const result=await cleanupLegacyBcrp(interaction.guild);
          await interaction.editReply({content:`**BlancoCountyRP legacy cleanup complete.**\n\n**Channels removed:** ${result.deletedChannels.length}\n**Categories removed:** ${result.deletedCategories.length}\n**Old department roles removed:** ${result.deletedRoles.length}\n\nCurrent **BCRP |** setup channels and roles were protected.`});
        } catch(error) { console.error('BCRP cleanup error:',error); await interaction.editReply({content:`Cleanup stopped because Discord returned an error: **${error.message}**`}).catch(()=>{}); }
        return;
      }
