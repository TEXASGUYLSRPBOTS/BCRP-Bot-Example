...
const APPLICATION_CATEGORY_NAME = 'BlancoCountyRP Applications';
const APPLICATION_CHANNEL_NAME = 'applications';
const APPLICATION_RESULTS_CHANNEL_NAME = 'results';
const APPLICATION_REVIEW_CHANNEL_NAME = 'staff-review';
...
function sessionChannel(guild) {
  if (SESSION_CHANNEL_ID) {
    return guild.channels.cache.get(SESSION_CHANNEL_ID) || null;
  }
  return null;
}
