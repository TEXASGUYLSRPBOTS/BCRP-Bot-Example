...
// ============================================================
// BCRP ROLE SETUP / LEGACY CLEANUP
// ============================================================
...
const BCRP_SETUP_ROLES = [
  ...
  'Official Blanco County Roleplay Bots',
  '─────────',
  'BCRP | Staff Coordinator',
  'BCRP | Discord Management',
  'BCRP | Staff Management',
  'BCRP | Senior High Rank',
  '─────────',
  'BCRP | Head Board Of Director's',
  'BCRP | Executive Board Of Director's',
  'BCRP | Board Of Director's',
  '─────────',
  'BCRP | Internal Affair's Team',
  'BCRP | Server Management',
  'BCRP | High Rank',
  '─────────',
  'BCRP | Head Administrator',
  'BCRP | Administrator',
  'BCRP | Trial Administrator',
  'BCRP | Administration Team',
  '─────────',
  'BCRP | Head Moderator',
  'BCRP | Moderator',
  'BCRP | Trial Moderator',
  'BCRP | Moderation Team',
  '─────────',
  'BOTS',
  'BCRP | Employee',
  'BCRP | Staff Team',
  'BCRP | Partnership Manager',
  'BCRP | Media Team Head',
  'BCRP | Media Team',
  '─────────',
  'BCRP | High Profile Member',
  'BCRP | Gold Supporter Member',
  'BCRP | Silver Supporter Member',
  '✓ | Member',
  '✗ | Unverified',
  '─────────',
  'BCRP | Staff Strike 3',
  'BCRP | Staff Strike 2',
  'BCRP | Staff Strike 1',
  'BCRP | HR Staff Termination',
  'BCRP | Staff Termination',
  'BCRP | Blacklisted',
  'BCRP | Under Investigation',
  '─────────',
  '𝒟 | Blanco County Fire & EMS',
  '𝒟 | Blanco County Sheriff',
  '𝒟 | Johnson Police',
  '𝒟 | Texas DOT',
  'Department Ambassador',
  '𝒟 | Whitelisted Member',
  '─────────',
  '𝓟 | Announcement Ping',
  '𝓟 | Department Ping',
  '𝓟 | Session Ping',
  '𝓟 | Session Vote Ping',
  '𝓟 | Session Boost Ping',
  '𝓟 | Session Staff Vote Ping',
  '𝓟 | Daily Bible Verse Ping',
  '𝓟 | Dead Chat Revive Ping',
  '𝓟 | Partnership Ping',
  '─────────',
  'On Duty',
  'On Break',
  ...
  '✓ | SSU Perms',
  '✓ | SSD Perms',
  'BCRP | Need-Retraining',
  'BCRP | Need-Training',
  'BCRP | Waiting-Ride-Along',
  'BCRP | Waiting-Exam',
  'BCRP | Staff Trainer'
];

// Exact legacy names are intentionally separated from the current BCRP setup names.
// /cleanup only removes these legacy resources and the BCRP setup roles above.
const BCRP_LEGACY_CATEGORY_NAMES = [
  'KCRP | Welcome Center',
  'KCRP | Community',
  'KCRP | Operations',
  'KCRP | Staff Area',
...
const BCRP_LEGACY_CHANNEL_NAMES = [
  'welcome',
  'dashboard',
  'assistance',
  'verify',
...
const BCRP_ROLE_PERMISSION_PROFILES = {
  ...
  '♚ | Co-Founder': [PermissionFlagsBits.Administrator],
  '♚ | Director': [PermissionFlagsBits.Administrator],
  '♚ | Deputy Director': [
  ...
  'BCRP | Trial Administrator': [PermissionFlagsBits.ManageMessages, PermissionFlagsBits.ModerateMembers],
  'BCRP | Administration Team': [PermissionFlagsBits.ManageMessages, PermissionFlagsBits.ModerateMembers],
  ...
  'BCRP | Moderator': [PermissionFlagsBits.ManageMessages, PermissionFlagsBits.ModerateMembers, PermissionFlagsBits.KickMembers],
  'BCRP | Trial Moderator': [PermissionFlagsBits.ManageMessages, PermissionFlagsBits.ModerateMembers],
  'BCRP | Moderation Team': [PermissionFlagsBits.ManageMessages, PermissionFlagsBits.ModerateMembers],
  ...
  'BCRP | Employee': [PermissionFlagsBits.ViewChannel, PermissionFlagsBits.ReadMessageHistory],
  'BCRP | Staff Team': [PermissionFlagsBits.ViewChannel, PermissionFlagsBits.ReadMessageHistory, PermissionFlagsBits.SendMessages],
  'BCRP | Partnership Manager': [PermissionFlagsBits.ViewChannel, PermissionFlagsBits.ReadMessageHistory, PermissionFlagsBits.SendMessages],
  'BCRP | Media Team Head': [PermissionFlagsBits.ViewChannel, PermissionFlagsBits.ReadMessageHistory, PermissionFlagsBits.SendMessages, PermissionFlagsBits.AttachFiles, PermissionFlagsBits.EmbedLinks],
  'BCRP | Media Team': [PermissionFlagsBits.ViewChannel, PermissionFlagsBits.ReadMessageHistory, PermissionFlagsBits.SendMessages, PermissionFlagsBits.AttachFiles],
  'Discord Staff': [PermissionFlagsBits.ViewChannel, PermissionFlagsBits.ReadMessageHistory, PermissionFlagsBits.SendMessages],
  '✓ | SSU Perms': [PermissionFlagsBits.ViewChannel, PermissionFlagsBits.ReadMessageHistory, PermissionFlagsBits.SendMessages],
  '✓ | SSD Perms': [PermissionFlagsBits.ViewChannel, PermissionFlagsBits.ReadMessageHistory, PermissionFlagsBits.SendMessages],
  'BCRP | Staff Trainer': [PermissionFlagsBits.ViewChannel, PermissionFlagsBits.ReadMessageHistory, PermissionFlagsBits.SendMessages]
};

const BCRP_STAFF_ROLE_NAMES = [
  '♛ | Founder', '♚ | Co-Founder', '♚ | Director', '♚ | Deputy Director',
  'BCRP | Leadership Team', 'BCRP | Staff Coordinator', 'BCRP | Discord Management',
  'BCRP | Staff Management', 'BCRP | Senior High Rank',
  ...
  'BCRP | Employee', 'BCRP | Staff Team', 'BCRP | Partnership Manager', 'BCRP | Media Team Head', 'BCRP | Media Team',
  'Discord Staff', '✓ | SSU Perms', '✓ | SSD Perms', 'BCRP | Staff Trainer'
];

function getBcrpRole(guild, name) {
...
async function ensureBcrpRoles(guild) {
  ...
  const created = [];
  const orderedRoles = [];
  const separatorCountNeeded = BCRP_SETUP_ROLES.filter(name => name === '─────────').length;
  let existingSeparators = guild.roles.cache.filter(role => role.name === '─────────' && !role.managed).sort((a, b) => b.position - a.position);
  const separatorQueue = [...existingSeparators.values()];

  for (const name of BCRP_SETUP_ROLES) {
    let role;
    if (name === '─────────') {
      role = separatorQueue.shift();
      if (!role) {
        role = await guild.roles.create({
          ...
          hoist: false,
          permissions: [],
          reason: 'BlancoCountyRP /setup role structure separator'
        });
        created.push(role.name);
      }
    } else {
      role = getBcrpRole(guild, name);
      if (!role) {
        role = await guild.roles.create({
          name,
          color: 0xFFFFFF,
          mentionable: false,
          hoist: false,
          permissions: BCRP_ROLE_PERMISSION_PROFILES[name] || [],
          reason: 'BlancoCountyRP /setup role structure'
        });
        created.push(role.name);
      } else if (role.editable) {
        await role.setPermissions(BCRP_ROLE_PERMISSION_PROFILES[name] || []).catch(() => {});
      }
    }
    if (!role) continue;
    orderedRoles.push(role);
    if (!roles[name]) roles[name] = role;
  }

  // Arrange the full requested structure from highest to lowest below the bot's role.
  const me = guild.members.me || await guild.members.fetchMe().catch(() => null);
  if (me?.roles?.highest) {
    let position = Math.max(1, me.roles.highest.position - 1);
    for (const role of orderedRoles) {
      if (!role || role.managed || position < 1) continue;
      await role.setPosition(position, { reason: 'BlancoCountyRP /setup role hierarchy' }).catch(() => {});
      position--;
    }
  }

  return { roles, roleList: orderedRoles, created };
}

async function cleanupBcrpLegacyResources(guild) {
  const deletedChannels = [];
  const deletedCategories = [];
  const deletedRoles = [];

  const currentCategoryNames = new Set(Object.values(BCRP_SETUP_CATEGORIES));
  const currentChannelNames = new Set(BCRP_SETUP_CHANNELS.map(def => def.name));

  // Remove exact legacy categories first. Children are removed by Discord with the category.
  for (const channel of [...guild.channels.cache.values()]) {
    if (channel.type !== ChannelType.GuildCategory) continue;
    if (currentCategoryNames.has(channel.name)) continue;
    if (!BCRP_LEGACY_CATEGORY_NAMES.includes(channel.name)) continue;
    await channel.delete('BlancoCountyRP /cleanup legacy category').then(() => deletedCategories.push(channel.name)).catch(() => {});
  }

  // Remove exact legacy channel names, but never touch a current BCRP setup channel.
  for (const channel of [...guild.channels.cache.values()]) {
    if (!channel || channel.type === ChannelType.GuildCategory) continue;
    if (currentChannelNames.has(channel.name)) continue;
    if (!BCRP_LEGACY_CHANNEL_NAMES.includes(channel.name)) continue;
    await channel.delete('BlancoCountyRP /cleanup legacy channel').then(() => deletedChannels.push(channel.name)).catch(() => {});
  }

  // Remove every role from the requested BCRP role structure. Separator roles are included.
  for (const name of BCRP_SETUP_ROLES) {
    const matching = guild.roles.cache.filter(role => role.name === name && role.id !== guild.id);
    for (const role of matching.values()) {
      await role.delete('BlancoCountyRP /cleanup BCRP roles').then(() => deletedRoles.push(role.name)).catch(() => {});
    }
  }
...
function getStaffAccessRoleIds(guild) {
  const names = new Set(BCRP_STAFF_ROLE_NAMES);
  return guild.roles.cache
    .filter(role => !role.managed && names.has(role.name))
    .map(role => role.id);
}

function getDepartmentRoleNames() {
  return [
    '𝒟 | Blanco County Fire & EMS',
    '𝒟 | Blanco County Sheriff',
    '𝒟 | Johnson Police',
...
function getBcrpMemberRoleIds(guild) {
  return [
    getBcrpRole(guild, '✓ | Member'),
    getBcrpRole(guild, '𝒟 | Whitelisted Member')
...
function setupPublicOverwrites(guild, readonly = false) {
  ...
  // Verified/member roles can participate in normal community channels.
  if (!readonly) {
  ...
  // Department roles receive access to department-oriented public areas.
  for (const name of getDepartmentRoleNames()) {
    const role = getBcrpRole(guild, name);
    if (role) {
      overwrites.push({
        id: role.id,
        allow: [PermissionFlagsBits.ViewChannel, PermissionFlagsBits.ReadMessageHistory]
...
function setupStaffOverwrites(guild, readonly = false) {
  ...
  const specialAccessNames = ['BCRP | Employee', 'BCRP | Staff Team', 'BCRP | Partnership Manager', 'BCRP | Media Team Head', 'BCRP | Media Team', 'Discord Staff', '✓ | SSU Perms', '✓ | SSD Perms', 'BCRP | Staff Trainer'];
  for (const name of specialAccessNames) {
    const role = getBcrpRole(guild, name);
    if (!role) continue;
    overwrites.push({
      id: role.id,
...
async function setupBcrpServer(guild, { rebuild = true, visibility = 'recommended' } = {}) {
  ...
  return { categories, channels: created, ticketCategory, roles: roleResult.roles, roleList: roleResult.roleList, createdRoles: roleResult.created };
}
...
const commands = [
  ...
  new SlashCommandBuilder()
    .setName('cleanup')
    .setDescription('Remove the old legacy channels and the BCRP role structure.')
    .setDefaultMemberPermissions(PermissionFlagsBits.Administrator),
  ...
  async interaction => {
    ...
    try {
        ...
        try {
          ...
          await interaction.editReply({
            content:
              ...
              `**New Roles Created:** ${(result.createdRoles || []).length}\n` +
      ...
      if (interaction.isChatInputCommand() && interaction.commandName === 'cleanup') {
        if (!interaction.guild) {
          return interaction.reply({ content: 'Cleanup can only be used inside a server.', ephemeral: true });
        }
        if (!interaction.memberPermissions?.has(PermissionFlagsBits.Administrator)) {
          return interaction.reply({ content: 'You need **Administrator** permission to use `/cleanup`.', ephemeral: true });
        }

        await interaction.deferReply({ ephemeral: true });
        try {
          const result = await cleanupBcrpLegacyResources(interaction.guild);
          return interaction.editReply({
            content:
              '**BlancoCountyRP legacy cleanup complete.**\n\n' +
              `**Legacy Categories Deleted:** ${result.deletedCategories.length}\n` +
              `**Legacy Channels Deleted:** ${result.deletedChannels.length}\n` +
              `**BCRP Roles Deleted:** ${result.deletedRoles.length}\n\n` +
              'Current BCRP setup categories and channels were protected and were not targeted by this cleanup.'
          });
        } catch (error) {
          console.error('BCRP cleanup error:', error);
          return interaction.editReply({ content: `Cleanup stopped because Discord returned an error: **${error.message}**` });
        }
      }
